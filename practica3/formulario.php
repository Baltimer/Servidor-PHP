...
<body>
<?php
    $agenda = []; // Array asociativo donde se guardan los contactos
    ...
    // Si nos pasan la agenda, la guardamos en el array designado
    if(isset($_POST['agenda']) && count($_POST['agenda']) > 0){
        $agenda = $_POST['agenda'];
    }
...
?>
    ...
    <form method="post">
        <fieldset>
            ...
            <?php 
                // Printamos todos los contactos en un input hidden
                if(count($agenda) > 0) {
